...
def apply_filters(df, selected_product_brands, product_search, selected_competitors):
    out = df.copy()
...
def main():
    ...
    filtered_full = apply_filters(transformed, selected_product_brands, product_search, selected_competitors)
